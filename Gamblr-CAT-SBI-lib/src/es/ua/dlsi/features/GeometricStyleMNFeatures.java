 ...
 * @author miquel
 */
public class GeometricStyleMNFeatures extends FeaturesComputer{
    
    public GeometricStyleMNFeatures(Segment sourcesegment, TranslationUnit tu,
                ...
                for(int nlen=0;nlen<segmaxlen;nlen++){
                    ...
                    if(coveringintersec_p>0 || coveringintersec_n>0){
                        ...
                        feat_tmp[mlen*segmaxlen*2+nlen*2]=
                                (double)coveringintersec_p/(coveringintersec_p
                                +coveringintersec_n);
                        //Negative source
                        feat_tmp[mlen*segmaxlen*2+nlen*2+1]=
                                (double)coveringintersec_n/(coveringintersec_p
                                +coveringintersec_n);
                    }
                    else{
                        //Positive source
