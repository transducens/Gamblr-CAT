 ...
 * @author miquel
 */
public class GeometricStyleMNFeaturesOnlyPosWithQuantitativeInfoNormalised extends FeaturesComputer{
    
    public GeometricStyleMNFeaturesOnlyPosWithQuantitativeInfoNormalised(Segment sourcesegment, TranslationUnit tu,
